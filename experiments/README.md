...
driftdetect/
  ...
  adapters/      Real corpora -> CallRecord ledgers, each with a labels
                 ...
                 - trace_content.py   the TRACE analogue: L1/L3 sidecars
                                      next to the trace ledger (plain
                                      call parameters + assistant text)
  ...
  eval_trace_transfer.py  follow-up E1 transfer: the frozen L1b rules
                          and L3 patterns applied unchanged to TRACE —
                          cross-corpus, cross-scaffold, whole corpus
                          held-out
